...
Partial Public Class _VBE_DatamartDataSet2
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/_VBE_DatamartDataSet21.xsd"
    ...
    Partial Public Class CM_PATIENT_CONTACT_DOCTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CM_PATIENT_CONTACT_DOC] WHERE (([PATIENT_ID] = @Original_PATIE"& _ 
                ...
                ") AND ((@IsNull_CONTACT_MADE_REASON = 1 AND [CONTACT_MADE_REASON] IS NULL) OR (["& _ 
                "CONTACT_MADE_REASON] = @Original_CONTACT_MADE_REASON)) AND ((@IsNull_CONTACT_NOT"& _ 
                "_MADE_REASON = 1 AND [CONTACT_NOT_MADE_REASON] IS NULL) OR ([CONTACT_NOT_MADE_RE"& _ 
                "ASON] = @Original_CONTACT_NOT_MADE_REASON)) AND ((@IsNull_RETURN_CALL_DATE = 1 A"& _ 
                "ND [RETURN_CALL_DATE] IS NULL) OR ([RETURN_CALL_DATE] = @Original_RETURN_CALL_DA"& _ 
                "TE)) AND ((@IsNull_APPOINTMENT_DATE_RESULT = 1 AND [APPOINTMENT_DATE_RESULT] IS "& _ 
                "NULL) OR ([APPOINTMENT_DATE_RESULT] = @Original_APPOINTMENT_DATE_RESULT)) AND (("& _ 
                "@IsNull_DD_NOT_CONTACT_FLAG = 1 AND [DD_NOT_CONTACT_FLAG] IS NULL) OR ([DD_NOT_C"& _ 
                "ONTACT_FLAG] = @Original_DD_NOT_CONTACT_FLAG)) AND ((@IsNull_CASE_MANAGEMENT_PAT"& _ 
                "IENT_REFERRAL_SOURCE = 1 AND [CASE_MANAGEMENT_PATIENT_REFERRAL_SOURCE] IS NULL) "& _ 
                "OR ([CASE_MANAGEMENT_PATIENT_REFERRAL_SOURCE] = @Original_CASE_MANAGEMENT_PATIEN"& _ 
                "T_REFERRAL_SOURCE)) AND ((@IsNull_NETWORK_PATIENT_ADDR_LINE_1 = 1 AND [NETWORK_P"& _ 
                "ATIENT_ADDR_LINE_1] IS NULL) OR ([NETWORK_PATIENT_ADDR_LINE_1] = @Original_NETWO"& _ 
                "RK_PATIENT_ADDR_LINE_1)) AND ((@IsNull_NETWORK_PATIENT_ADDR_LINE_2 = 1 AND [NETW"& _ 
                "ORK_PATIENT_ADDR_LINE_2] IS NULL) OR ([NETWORK_PATIENT_ADDR_LINE_2] = @Original_"& _ 
                "NETWORK_PATIENT_ADDR_LINE_2)) AND ((@IsNull_NETWORK_PATIENT_CITY = 1 AND [NETWOR"& _ 
                "K_PATIENT_CITY] IS NULL) OR ([NETWORK_PATIENT_CITY] = @Original_NETWORK_PATIENT_"& _ 
                "CITY)) AND ((@IsNull_NETWORK_PATIENT_STATE = 1 AND [NETWORK_PATIENT_STATE] IS NU"& _ 
                "LL) OR ([NETWORK_PATIENT_STATE] = @Original_NETWORK_PATIENT_STATE)) AND ((@IsNul"& _ 
                "l_NETWORK_PATIENT_ZIP_CODE = 1 AND [NETWORK_PATIENT_ZIP_CODE] IS NULL) OR ([NETW"& _ 
                "ORK_PATIENT_ZIP_CODE] = @Original_NETWORK_PATIENT_ZIP_CODE)) AND ((@IsNull_NETWO"& _ 
                "RK_PATIENT_HOME_PHONE = 1 AND [NETWORK_PATIENT_HOME_PHONE] IS NULL) OR ([NETWORK"& _ 
                "_PATIENT_HOME_PHONE] = @Original_NETWORK_PATIENT_HOME_PHONE)) AND ((@IsNull_NETW"& _ 
                "ORK_PATIENT_WORK_PHONE = 1 AND [NETWORK_PATIENT_WORK_PHONE] IS NULL) OR ([NETWOR"& _ 
                "K_PATIENT_WORK_PHONE] = @Original_NETWORK_PATIENT_WORK_PHONE)) AND ((@IsNull_NET"& _ 
                "WORK_PATIENT_MOBILE_PHONE = 1 AND [NETWORK_PATIENT_MOBILE_PHONE] IS NULL) OR ([N"& _ 
                "ETWORK_PATIENT_MOBILE_PHONE] = @Original_NETWORK_PATIENT_MOBILE_PHONE)) AND ((@I"& _ 
                "sNull_NETWORK_PATIENT_EMAIL = 1 AND [NETWORK_PATIENT_EMAIL] IS NULL) OR ([NETWOR"& _ 
                "K_PATIENT_EMAIL] = @Original_NETWORK_PATIENT_EMAIL)) AND ((@IsNull_ACTIVE_PATIEN"& _ 
                "T_FLAG = 1 AND [ACTIVE_PATIENT_FLAG] IS NULL) OR ([ACTIVE_PATIENT_FLAG] = @Origi"& _ 
                "nal_ACTIVE_PATIENT_FLAG)) AND ((@IsNull_NOTE = 1 AND [NOTE] IS NULL) OR ([NOTE] "& _ 
                "= @Original_NOTE)) AND ((@IsNull_STATUS = 1 AND [STATUS] IS NULL) OR ([STATUS] ="& _ 
                " @Original_STATUS)) AND ((@IsNull_MAX_ATTRIBUTION_MONTH = 1 AND [MAX_ATTRIBUTION"& _ 
                "_MONTH] IS NULL) OR ([MAX_ATTRIBUTION_MONTH] = @Original_MAX_ATTRIBUTION_MONTH))"& _ 
                " AND ((@IsNull_LAST_REVISE_DATE = 1 AND [LAST_REVISE_DATE] IS NULL) OR ([LAST_RE"& _ 
                "VISE_DATE] = @Original_LAST_REVISE_DATE)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_CONTACT_MADE_REASON", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_MADE_REASON", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CONTACT_MADE_REASON", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_MADE_REASON", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_CONTACT_NOT_MADE_REASON", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_NOT_MADE_REASON", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CONTACT_NOT_MADE_REASON", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_NOT_MADE_REASON", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CM_PATIENT_CONTACT_DOC] ([PATIENT_ID], [OUTREACH_DATE], [OUTRE"& _ 
                ...
                "[REASON_FOR_OUTREACH], [CONTACT_MADE_REASON], [CONTACT_NOT_MADE_REASON], [RETURN"& _ 
                "_CALL_DATE], [APPOINTMENT_DATE_RESULT], [DD_NOT_CONTACT_FLAG], [CASE_MANAGEMENT_"& _ 
                "PATIENT_REFERRAL_SOURCE], [NETWORK_PATIENT_ADDR_LINE_1], [NETWORK_PATIENT_ADDR_L"& _ 
                "INE_2], [NETWORK_PATIENT_CITY], [NETWORK_PATIENT_STATE], [NETWORK_PATIENT_ZIP_CO"& _ 
                "DE], [NETWORK_PATIENT_HOME_PHONE], [NETWORK_PATIENT_WORK_PHONE], [NETWORK_PATIEN"& _ 
                "T_MOBILE_PHONE], [NETWORK_PATIENT_EMAIL], [ACTIVE_PATIENT_FLAG], [NOTE], [STATUS"& _ 
                "], [MAX_ATTRIBUTION_MONTH], [LAST_REVISE_DATE]) VALUES (@PATIENT_ID, @OUTREACH_D"& _ 
                "ATE, @OUTREACH_ENTRY_DATETIME, @OUTREACH_CONTACT_PERSON, @OUTREACH_CONTACT_PERSO"& _ 
                "N_NAME, @REASON_FOR_OUTREACH, @CONTACT_MADE_REASON, @CONTACT_NOT_MADE_REASON, @R"& _ 
                "ETURN_CALL_DATE, @APPOINTMENT_DATE_RESULT, @DD_NOT_CONTACT_FLAG, @CASE_MANAGEMEN"& _ 
                "T_PATIENT_REFERRAL_SOURCE, @NETWORK_PATIENT_ADDR_LINE_1, @NETWORK_PATIENT_ADDR_L"& _ 
                "INE_2, @NETWORK_PATIENT_CITY, @NETWORK_PATIENT_STATE, @NETWORK_PATIENT_ZIP_CODE,"& _ 
                " @NETWORK_PATIENT_HOME_PHONE, @NETWORK_PATIENT_WORK_PHONE, @NETWORK_PATIENT_MOBI"& _ 
                "LE_PHONE, @NETWORK_PATIENT_EMAIL, @ACTIVE_PATIENT_FLAG, @NOTE, @STATUS, @MAX_ATT"& _ 
                "RIBUTION_MONTH, @LAST_REVISE_DATE);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT PATIENT_ID, OUTREACH_DATE, OUTREACH_"& _ 
                "ENTRY_DATETIME, OUTREACH_CONTACT_PERSON, OUTREACH_CONTACT_PERSON_NAME, REASON_FO"& _ 
                "R_OUTREACH, CONTACT_MADE_REASON, CONTACT_NOT_MADE_REASON, RETURN_CALL_DATE, APPO"& _ 
                "INTMENT_DATE_RESULT, DD_NOT_CONTACT_FLAG, CASE_MANAGEMENT_PATIENT_REFERRAL_SOURC"& _ 
                "E, NETWORK_PATIENT_ADDR_LINE_1, NETWORK_PATIENT_ADDR_LINE_2, NETWORK_PATIENT_CIT"& _ 
                "Y, NETWORK_PATIENT_STATE, NETWORK_PATIENT_ZIP_CODE, NETWORK_PATIENT_HOME_PHONE, "& _ 
                "NETWORK_PATIENT_WORK_PHONE, NETWORK_PATIENT_MOBILE_PHONE, NETWORK_PATIENT_EMAIL,"& _ 
                " ACTIVE_PATIENT_FLAG, NOTE, STATUS, MAX_ATTRIBUTION_MONTH, LAST_REVISE_DATE FROM"& _ 
                " CM_PATIENT_CONTACT_DOC WHERE (OUTREACH_DATE = @OUTREACH_DATE) AND (OUTREACH_ENT"& _ 
                "RY_DATETIME = @OUTREACH_ENTRY_DATETIME) AND (PATIENT_ID = @PATIENT_ID) ORDER BY "& _ 
                "PATIENT_ID, OUTREACH_DATE DESC, OUTREACH_ENTRY_DATETIME DESC"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CONTACT_MADE_REASON", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_MADE_REASON", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CONTACT_NOT_MADE_REASON", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_NOT_MADE_REASON", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[CM_PATIENT_CONTACT_DOC] SET [PATIENT_ID] = @PATIENT_ID, [OUTREACH_D"& _ 
                ...
                " [CONTACT_MADE_REASON] = @CONTACT_MADE_REASON, [CONTACT_NOT_MADE_REASON] = @CONT"& _ 
                "ACT_NOT_MADE_REASON, [RETURN_CALL_DATE] = @RETURN_CALL_DATE, [APPOINTMENT_DATE_R"& _ 
                "ESULT] = @APPOINTMENT_DATE_RESULT, [DD_NOT_CONTACT_FLAG] = @DD_NOT_CONTACT_FLAG,"& _ 
                " [CASE_MANAGEMENT_PATIENT_REFERRAL_SOURCE] = @CASE_MANAGEMENT_PATIENT_REFERRAL_S"& _ 
                "OURCE, [NETWORK_PATIENT_ADDR_LINE_1] = @NETWORK_PATIENT_ADDR_LINE_1, [NETWORK_PA"& _ 
                "TIENT_ADDR_LINE_2] = @NETWORK_PATIENT_ADDR_LINE_2, [NETWORK_PATIENT_CITY] = @NET"& _ 
                "WORK_PATIENT_CITY, [NETWORK_PATIENT_STATE] = @NETWORK_PATIENT_STATE, [NETWORK_PA"& _ 
                "TIENT_ZIP_CODE] = @NETWORK_PATIENT_ZIP_CODE, [NETWORK_PATIENT_HOME_PHONE] = @NET"& _ 
                "WORK_PATIENT_HOME_PHONE, [NETWORK_PATIENT_WORK_PHONE] = @NETWORK_PATIENT_WORK_PH"& _ 
                "ONE, [NETWORK_PATIENT_MOBILE_PHONE] = @NETWORK_PATIENT_MOBILE_PHONE, [NETWORK_PA"& _ 
                "TIENT_EMAIL] = @NETWORK_PATIENT_EMAIL, [ACTIVE_PATIENT_FLAG] = @ACTIVE_PATIENT_F"& _ 
                "LAG, [NOTE] = @NOTE, [STATUS] = @STATUS, [MAX_ATTRIBUTION_MONTH] = @MAX_ATTRIBUT"& _ 
                "ION_MONTH, [LAST_REVISE_DATE] = @LAST_REVISE_DATE WHERE (([PATIENT_ID] = @Origin"& _ 
                "al_PATIENT_ID) AND ([OUTREACH_DATE] = @Original_OUTREACH_DATE) AND ([OUTREACH_EN"& _ 
                "TRY_DATETIME] = @Original_OUTREACH_ENTRY_DATETIME) AND ([OUTREACH_CONTACT_PERSON"& _ 
                "] = @Original_OUTREACH_CONTACT_PERSON) AND ([OUTREACH_CONTACT_PERSON_NAME] = @Or"& _ 
                "iginal_OUTREACH_CONTACT_PERSON_NAME) AND ((@IsNull_REASON_FOR_OUTREACH = 1 AND ["& _ 
                "REASON_FOR_OUTREACH] IS NULL) OR ([REASON_FOR_OUTREACH] = @Original_REASON_FOR_O"& _ 
                "UTREACH)) AND ((@IsNull_CONTACT_MADE_REASON = 1 AND [CONTACT_MADE_REASON] IS NUL"& _ 
                "L) OR ([CONTACT_MADE_REASON] = @Original_CONTACT_MADE_REASON)) AND ((@IsNull_CON"& _ 
                "TACT_NOT_MADE_REASON = 1 AND [CONTACT_NOT_MADE_REASON] IS NULL) OR ([CONTACT_NOT"& _ 
                "_MADE_REASON] = @Original_CONTACT_NOT_MADE_REASON)) AND ((@IsNull_RETURN_CALL_DA"& _ 
                "TE = 1 AND [RETURN_CALL_DATE] IS NULL) OR ([RETURN_CALL_DATE] = @Original_RETURN"& _ 
                "_CALL_DATE)) AND ((@IsNull_APPOINTMENT_DATE_RESULT = 1 AND [APPOINTMENT_DATE_RES"& _ 
                "ULT] IS NULL) OR ([APPOINTMENT_DATE_RESULT] = @Original_APPOINTMENT_DATE_RESULT)"& _ 
                ") AND ((@IsNull_DD_NOT_CONTACT_FLAG = 1 AND [DD_NOT_CONTACT_FLAG] IS NULL) OR (["& _ 
                "DD_NOT_CONTACT_FLAG] = @Original_DD_NOT_CONTACT_FLAG)) AND ((@IsNull_CASE_MANAGE"& _ 
                "MENT_PATIENT_REFERRAL_SOURCE = 1 AND [CASE_MANAGEMENT_PATIENT_REFERRAL_SOURCE] I"& _ 
                "S NULL) OR ([CASE_MANAGEMENT_PATIENT_REFERRAL_SOURCE] = @Original_CASE_MANAGEMEN"& _ 
                "T_PATIENT_REFERRAL_SOURCE)) AND ((@IsNull_NETWORK_PATIENT_ADDR_LINE_1 = 1 AND [N"& _ 
                "ETWORK_PATIENT_ADDR_LINE_1] IS NULL) OR ([NETWORK_PATIENT_ADDR_LINE_1] = @Origin"& _ 
                "al_NETWORK_PATIENT_ADDR_LINE_1)) AND ((@IsNull_NETWORK_PATIENT_ADDR_LINE_2 = 1 A"& _ 
                "ND [NETWORK_PATIENT_ADDR_LINE_2] IS NULL) OR ([NETWORK_PATIENT_ADDR_LINE_2] = @O"& _ 
                "riginal_NETWORK_PATIENT_ADDR_LINE_2)) AND ((@IsNull_NETWORK_PATIENT_CITY = 1 AND"& _ 
                " [NETWORK_PATIENT_CITY] IS NULL) OR ([NETWORK_PATIENT_CITY] = @Original_NETWORK_"& _ 
                "PATIENT_CITY)) AND ((@IsNull_NETWORK_PATIENT_STATE = 1 AND [NETWORK_PATIENT_STAT"& _ 
                "E] IS NULL) OR ([NETWORK_PATIENT_STATE] = @Original_NETWORK_PATIENT_STATE)) AND "& _ 
                "((@IsNull_NETWORK_PATIENT_ZIP_CODE = 1 AND [NETWORK_PATIENT_ZIP_CODE] IS NULL) O"& _ 
                "R ([NETWORK_PATIENT_ZIP_CODE] = @Original_NETWORK_PATIENT_ZIP_CODE)) AND ((@IsNu"& _ 
                "ll_NETWORK_PATIENT_HOME_PHONE = 1 AND [NETWORK_PATIENT_HOME_PHONE] IS NULL) OR ("& _ 
                "[NETWORK_PATIENT_HOME_PHONE] = @Original_NETWORK_PATIENT_HOME_PHONE)) AND ((@IsN"& _ 
                "ull_NETWORK_PATIENT_WORK_PHONE = 1 AND [NETWORK_PATIENT_WORK_PHONE] IS NULL) OR "& _ 
                "([NETWORK_PATIENT_WORK_PHONE] = @Original_NETWORK_PATIENT_WORK_PHONE)) AND ((@Is"& _ 
                "Null_NETWORK_PATIENT_MOBILE_PHONE = 1 AND [NETWORK_PATIENT_MOBILE_PHONE] IS NULL"& _ 
                ") OR ([NETWORK_PATIENT_MOBILE_PHONE] = @Original_NETWORK_PATIENT_MOBILE_PHONE)) "& _ 
                "AND ((@IsNull_NETWORK_PATIENT_EMAIL = 1 AND [NETWORK_PATIENT_EMAIL] IS NULL) OR "& _ 
                "([NETWORK_PATIENT_EMAIL] = @Original_NETWORK_PATIENT_EMAIL)) AND ((@IsNull_ACTIV"& _ 
                "E_PATIENT_FLAG = 1 AND [ACTIVE_PATIENT_FLAG] IS NULL) OR ([ACTIVE_PATIENT_FLAG] "& _ 
                "= @Original_ACTIVE_PATIENT_FLAG)) AND ((@IsNull_NOTE = 1 AND [NOTE] IS NULL) OR "& _ 
                "([NOTE] = @Original_NOTE)) AND ((@IsNull_STATUS = 1 AND [STATUS] IS NULL) OR ([S"& _ 
                "TATUS] = @Original_STATUS)) AND ((@IsNull_MAX_ATTRIBUTION_MONTH = 1 AND [MAX_ATT"& _ 
                "RIBUTION_MONTH] IS NULL) OR ([MAX_ATTRIBUTION_MONTH] = @Original_MAX_ATTRIBUTION"& _ 
                "_MONTH)) AND ((@IsNull_LAST_REVISE_DATE = 1 AND [LAST_REVISE_DATE] IS NULL) OR ("& _ 
                "[LAST_REVISE_DATE] = @Original_LAST_REVISE_DATE)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT PATIENT_ID, OUTREACH"& _ 
                "_DATE, OUTREACH_ENTRY_DATETIME, OUTREACH_CONTACT_PERSON, OUTREACH_CONTACT_PERSON"& _ 
                "_NAME, REASON_FOR_OUTREACH, CONTACT_MADE_REASON, CONTACT_NOT_MADE_REASON, RETURN"& _ 
                "_CALL_DATE, APPOINTMENT_DATE_RESULT, DD_NOT_CONTACT_FLAG, CASE_MANAGEMENT_PATIEN"& _ 
                "T_REFERRAL_SOURCE, NETWORK_PATIENT_ADDR_LINE_1, NETWORK_PATIENT_ADDR_LINE_2, NET"& _ 
                "WORK_PATIENT_CITY, NETWORK_PATIENT_STATE, NETWORK_PATIENT_ZIP_CODE, NETWORK_PATI"& _ 
                "ENT_HOME_PHONE, NETWORK_PATIENT_WORK_PHONE, NETWORK_PATIENT_MOBILE_PHONE, NETWOR"& _ 
                "K_PATIENT_EMAIL, ACTIVE_PATIENT_FLAG, NOTE, STATUS, MAX_ATTRIBUTION_MONTH, LAST_"& _ 
                "REVISE_DATE FROM CM_PATIENT_CONTACT_DOC WHERE (OUTREACH_DATE = @OUTREACH_DATE) A"& _ 
                "ND (OUTREACH_ENTRY_DATETIME = @OUTREACH_ENTRY_DATETIME) AND (PATIENT_ID = @PATIE"& _ 
                "NT_ID) ORDER BY PATIENT_ID, OUTREACH_DATE DESC, OUTREACH_ENTRY_DATETIME DESC"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CONTACT_MADE_REASON", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_MADE_REASON", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CONTACT_NOT_MADE_REASON", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_NOT_MADE_REASON", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_CONTACT_MADE_REASON", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_MADE_REASON", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CONTACT_MADE_REASON", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_MADE_REASON", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_CONTACT_NOT_MADE_REASON", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_NOT_MADE_REASON", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CONTACT_NOT_MADE_REASON", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTACT_NOT_MADE_REASON", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT PATIENT_ID, OUTREACH_DATE, OUTREACH_ENTRY_DATETIME, OUTREACH_CONTACT_PERSO"& _ 
                "N, OUTREACH_CONTACT_PERSON_NAME, REASON_FOR_OUTREACH, CONTACT_MADE_REASON, CONTA"& _ 
                "CT_NOT_MADE_REASON, RETURN_CALL_DATE, APPOINTMENT_DATE_RESULT, DD_NOT_CONTACT_FL"& _ 
                "AG, CASE_MANAGEMENT_PATIENT_REFERRAL_SOURCE, NETWORK_PATIENT_ADDR_LINE_1, NETWOR"& _ 
                "K_PATIENT_ADDR_LINE_2, NETWORK_PATIENT_CITY, NETWORK_PATIENT_STATE, NETWORK_PATI"& _ 
                "ENT_ZIP_CODE, NETWORK_PATIENT_HOME_PHONE, NETWORK_PATIENT_WORK_PHONE, NETWORK_PA"& _ 
                "TIENT_MOBILE_PHONE, NETWORK_PATIENT_EMAIL, ACTIVE_PATIENT_FLAG, NOTE, STATUS, MA"& _ 
                "X_ATTRIBUTION_MONTH, LAST_REVISE_DATE FROM dbo.CM_PATIENT_CONTACT_DOC"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (CM"& _ 
                "_PATIENT_CONTACT_DOC.PATIENT_ID = @ContPatID)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY PATIENT_ID, OUTREACH_DAT"& _ 
                "E DESC, OUTREACH_ENTRY_DATETIME DESC"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@ContPatID", Global.System.Data.SqlDbType.BigInt, 8, Global.System.Data.ParameterDirection.Input, 0, 0, "PATIENT_ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function FillContHist(ByVal dataTable As _VBE_DatamartDataSet2.CM_PATIENT_CONTACT_DOCDataTable, ByVal ContPatID As Long) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(ContPatID,Long)
        ...
        Public Overloads Overridable Function GetData(ByVal ContPatID As Long) As _VBE_DatamartDataSet2.CM_PATIENT_CONTACT_DOCDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(ContPatID,Long)
        ...
        Public Overloads Overridable Function Delete( _
                    ...
                    ByVal Original_CONTACT_MADE_REASON As String,  _
                    ByVal Original_CONTACT_NOT_MADE_REASON As String,  _
            ...
            End If
            If (Original_CONTACT_MADE_REASON Is Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(7).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(8).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(7).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_CONTACT_MADE_REASON,String)
            End If
            If (Original_CONTACT_NOT_MADE_REASON Is Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(9).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(10).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(9).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_CONTACT_NOT_MADE_REASON,String)
            End If
        ...
        Public Overloads Overridable Function Insert( _
            ...
            End If
            If (CONTACT_MADE_REASON Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(6).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(6).Value = CType(CONTACT_MADE_REASON,String)
            End If
            If (CONTACT_NOT_MADE_REASON Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(7).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(7).Value = CType(CONTACT_NOT_MADE_REASON,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(CONTACT_MADE_REASON,String)
            End If
            If (CONTACT_NOT_MADE_REASON Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(7).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(CONTACT_NOT_MADE_REASON,String)
            End If
            If (RETURN_CALL_DATE.HasValue = true) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(34).Value = CType(Original_CONTACT_MADE_REASON,String)
            End If
            If (Original_CONTACT_NOT_MADE_REASON Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(36).Value = CType(Original_CONTACT_NOT_MADE_REASON,String)
            End If
            If (Original_RETURN_CALL_DATE.HasValue = true) Then
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_MAX_ATTRIBUTION_MONTH As Global.System.Nullable(Of Decimal),  _
                    ByVal Original_LAST_REVISE_DATE As Global.System.Nullable(Of Date)) As Integer
            Return Me.Update(Original_PATIENT_ID, Original_OUTREACH_DATE, Original_OUTREACH_ENTRY_DATETIME, OUTREACH_CONTACT_PERSON, OUTREACH_CONTACT_PERSON_NAME, REASON_FOR_OUTREACH, CONTACT_MADE_REASON, CONTACT_NOT_MADE_REASON, RETURN_CALL_DATE, APPOINTMENT_DATE_RESULT, DD_NOT_CONTACT_FLAG, CASE_MANAGEMENT_PATIENT_REFERRAL_SOURCE, NETWORK_PATIENT_ADDR_LINE_1, NETWORK_PATIENT_ADDR_LINE_2, NETWORK_PATIENT_CITY, NETWORK_PATIENT_STATE, NETWORK_PATIENT_ZIP_CODE, NETWORK_PATIENT_HOME_PHONE, NETWORK_PATIENT_WORK_PHONE, NETWORK_PATIENT_MOBILE_PHONE, NETWORK_PATIENT_EMAIL, ACTIVE_PATIENT_FLAG, NOTE, STATUS, MAX_ATTRIBUTION_MONTH, LAST_REVISE_DATE, Original_PATIENT_ID, Original_OUTREACH_DATE, Original_OUTREACH_ENTRY_DATETIME, Original_OUTREACH_CONTACT_PERSON, Original_OUTREACH_CONTACT_PERSON_NAME, Original_REASON_FOR_OUTREACH, Original_CONTACT_MADE_REASON, Original_CONTACT_NOT_MADE_REASON, Original_RETURN_CALL_DATE, Original_APPOINTMENT_DATE_RESULT, Original_DD_NOT_CONTACT_FLAG, Original_CASE_MANAGEMENT_PATIENT_REFERRAL_SOURCE, Original_NETWORK_PATIENT_ADDR_LINE_1, Original_NETWORK_PATIENT_ADDR_LINE_2, Original_NETWORK_PATIENT_CITY, Original_NETWORK_PATIENT_STATE, Original_NETWORK_PATIENT_ZIP_CODE, Original_NETWORK_PATIENT_HOME_PHONE, Original_NETWORK_PATIENT_WORK_PHONE, Original_NETWORK_PATIENT_MOBILE_PHONE, Original_NETWORK_PATIENT_EMAIL, Original_ACTIVE_PATIENT_FLAG, Original_NOTE, Original_STATUS, Original_MAX_ATTRIBUTION_MONTH, Original_LAST_REVISE_DATE)
        End Function
    End Class
